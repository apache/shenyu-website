...
* 选择器和规则是shenyu网关中最灵魂的东西。掌握好它，你可以对任何流量进行管理。
* 本篇主要详解shenyu网关中，选择器与规则的概念，以及如何使用。
...
*  ip匹配
    ...
    * 如果在shenyu前面使用了nginx代理，为了获取正确的ip，你可能要参考 [parsing-ip-and-host](../custom-parsing-ip-and-host)
...
* host匹配
  ...
  * 如果在shenyu前面使用了nginx代理，为了获取正确的host，你可能要参考 [parsing-ip-and-host](../custom-parsing-ip-and-host)
