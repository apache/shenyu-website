...
**1、在 private@shenyu.apache.org 的邮件列表发起讨论，提名由现有的PPMC成员发起，邮件内容主要陈述提名者的活动和社区贡献。** 
...
**2、在 private@shenyu.apache.org 的邮件列表发起投票，提名由现有的PPMC成员发起。** 
