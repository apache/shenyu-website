...
可以参考：[shenyu-examples-dubbo](https://github.com/apache/shenyu/tree/v2.5.0/shenyu-examples/shenyu-examples-dubbo)
...
* 参数传递：
  ...
  * 更多参数类型传递，可以参考 [shenyu-examples-dubbo](https://github.com/apache/shenyu/tree/v2.5.0/shenyu-examples/shenyu-examples-dubbo) 中的接口定义，以及参数传递方式。
