...
This document introduces how to quickly access the Apache ShenYu gateway using Motan RPC. You can get the code example of this document by clicking [here](https://github.com/apache/shenyu/tree/v2.4.2/shenyu-examples/shenyu-examples-motan).
...
Download [shenyu-examples-motan](https://github.com/apache/shenyu/tree/v2.4.2/shenyu-examples/shenyu-examples-motan) .
