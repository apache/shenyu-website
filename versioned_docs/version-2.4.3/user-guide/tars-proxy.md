...
For details about data synchronization configurations, see [Data Synchronization Config](../user-guide/use-data-sync)).
...
Please refer to： [shenyu-examples-tars](https://github.com/apache/shenyu/tree/v2.4.3/shenyu-examples/shenyu-examples-tars)
