...
you can refer to：[shenyu-examples-sofa](https://github.com/apache/shenyu/tree/v2.4.3/shenyu-examples/shenyu-examples-sofa)
...
* Parameter passing：
  ...
  * For more parameter type transfer, please refer to the interface definition in [shenyu-examples-sofa](https://github.com/apache/shenyu/tree/v2.4.3/shenyu-examples/shenyu-examples-sofa) and the parameter transfer method.
