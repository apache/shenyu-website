...
This document introduces how to quickly access the Apache ShenYu gateway using gRPC. You can get the code example of this document by clicking [here](https://github.com/apache/shenyu/tree/v2.4.1/shenyu-examples/shenyu-examples-grpc) .
...
Download [shenyu-examples-grpc](https://github.com/apache/shenyu/tree/v2.4.1/shenyu-examples/shenyu-examples-grpc)
