...
服务发现 详情 见  [discovery-mode](../../user-guide/discovery/discovery-mode.md)
...
- 当服务发现的类型选择zookeeper时，需要填写 Discovery-Zookeeper 配置 培训详情见 [discovery-mode](../../user-guide/discovery/discovery-mode.md)
