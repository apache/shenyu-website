...
This document introduces how to quickly access the Apache ShenYu gateway using Sofa RPC. You can get the code example of this document by clicking [here](https://github.com/apache/shenyu/tree/v2.5.0/shenyu-examples/shenyu-examples-sofa).
...
<img src="/img/shenyu/quick-start/sofa/sofa_open_en.png" width="60%" height="50%" />
...
Download [shenyu-examples-sofa](https://github.com/apache/shenyu/tree/v2.5.0/shenyu-examples/shenyu-examples-sofa), replace the register address in `spring-dubbo.xml` with your local zk address, such as:
