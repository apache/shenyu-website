...
This document introduces how to quickly access the Apache ShenYu Gateway using Tars. You can get the code example of this document by clicking [here](https://github.com/apache/shenyu/tree/v2.4.3/shenyu-examples/shenyu-examples-tars) .
...
Download [shenyu-examples-tars](https://github.com/apache/shenyu/tree/v2.4.3/shenyu-examples/shenyu-examples-tars) .
