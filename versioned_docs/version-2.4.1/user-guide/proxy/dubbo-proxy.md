...
Dubbo integration with gateway, please refer to : [shenyu-examples-dubbo](https://github.com/apache/shenyu/tree/v2.4.1/shenyu-examples/shenyu-examples-dubbo) .
...
* parameter deliver:
  ...
  * more parameter types, please refer to the interface definition in  [shenyu-examples-dubbo](https://github.com/apache/shenyu/tree/v2.4.1/shenyu-examples/shenyu-examples-dubbo) and parameter passing
      method.
