...
* `SpringBoot` 用户
  ...
  可以参考：[shenyu-examples-http](https://github.com/apache/shenyu/tree/v2.7.1/shenyu-examples/shenyu-examples-http)
...
* `SpringMvc` 用户
  ...
  可以参考：[shenyu-examples-springmvc](https://github.com/apache/shenyu/tree/v2.7.1/shenyu-examples/shenyu-examples-springmvc)
